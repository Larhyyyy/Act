    ...
    <div class="centered-container">
        <div class="container ">
            <div class="text-center" style="margin-top: 50px">
                {{-- <img class="d-block mx-auto mb-2" src="C:\Users\La Rhaine Rabino\Desktop\Activity_5\resources\views\pngtree-beach-logo-design-vector-png-image_874307.png" alt="" width="100"
                    height="100"> --}}
...
<footer class="text-muted text-center text-small fixed-bottom">
    <p class="mb-1 text-light">© 2019–2023 LarhyPh</p>
</footer>
